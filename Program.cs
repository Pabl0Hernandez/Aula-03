...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        {
            // Imprimir chave e valor do dici   onário
        ...
        bool achou = fila.Contains("Hygor");
        ...
        // Adicionar uma Pilha de Elementos ( Stack => Pilha)
        Stack<string> pilha = new Stack<string>();

        pilha.Push("Bob Esponja");
        pilha.Push("Diario De Um Banana");
        pilha.Push("acorda Mariquinha");
        ...
        string livroRetiradao = pilha.Pop();
        Console.WriteLine($"\nO livro retirado da pilha de livros foi: {livroRetiradao}\n");
        ...
        if (pilha.Contains("Diario De Um Banana"))
